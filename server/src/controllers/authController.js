...
/**
 * Register a new user (Faculty only)
...
exports.logout = async (req, res) => {
  try {
    // In JWT authentication, logout is primarily handled on client-side
...
/**
 * Create admin user (Protected - Admin only or initial setup)
